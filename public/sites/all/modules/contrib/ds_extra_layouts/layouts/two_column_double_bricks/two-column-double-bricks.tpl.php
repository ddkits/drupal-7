...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes;?> clearfix">
  ...
  <?php endif; ?>
    ...
    <<?php print $above_brick_wrapper; ?> class="ds-middle<?php print $above_brick_classes; ?>">
      <?php print $above_brick; ?>
    </<?php print $above_brick_wrapper; ?>>

    <div class="ds-middle">
    <<?php print $middle_left_wrapper; ?> class="ds-above-left<?php print $middle_left_classes; ?>">
      <?php print $middle_left; ?>
    </<?php print $middle_left_wrapper; ?>>

    <<?php print $middle_right_wrapper; ?> class="ds-above-right<?php print $middle_right_classes; ?>">
      <?php print $middle_right; ?>
    </<?php print $middle_right_wrapper; ?>>
    </div>

    <<?php print $below_brick_wrapper; ?> class="ds-middle<?php print $below_brick_classes; ?>">
